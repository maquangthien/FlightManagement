...
class Airline(db.Model):
    ...
    airplanes = relationship('Airplane', back_populates='airline', lazy=False)
...
class Airport(db.Model):
    ...
    departures = relationship('FlightDetails', foreign_keys='FlightDetails.departure_airport_id',
                              back_populates='departure_airport')
    arrivals = relationship('FlightDetails', foreign_keys='FlightDetails.arrival_airport_id',
...
if __name__ == "__main__":
    with app.app_context():
        ...
        db.session.commit()
        # tạo tuyến bay
        tb1 = Routes(origin="Hà Nội", destination="HCM")
        # tạo chuyến bay
        cb1 = Flight(departure_location="Hà Nội", destination_location="HCM", departure_time="2", route_id="1")
        # # tạo máy bay
        # mb1 = Airplane(name="MH370", airline_id ="1", flight_id="1", )
        db.session.add_all([cb1, tb1])
        db.session.commit()
